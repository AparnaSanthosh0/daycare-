    ...
    <Box>
      ...
      <Paper sx={{ p: 3 }}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={6}><Button sx={{ height: '100%' }} startIcon={<DirectionsBus />} variant="contained" onClick={()=>safe(()=>api.post('/api/staff-ops/transport', transport))}>Save Transport</Button></Grid>
          ...
          <Grid item xs={12} md={3}><Button fullWidth variant="outlined" startIcon={<Engineering />} onClick={()=>safe(()=>api.post('/api/staff-ops/pickups', { childId: pickup.childId, person: pickup.person }))}>Add Pickup</Button></Grid>
        </Grid>
      </Paper>
    </Box>
  );
